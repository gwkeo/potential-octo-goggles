...
def generate():
    ...
    if k == 5: # пересекающиеся прямые
        ...
        x0 = randint(1, 5)*(-1)**randint(1,2)
        y0 = randint(1, 5)*(-1)**randint(1,2)
        return no_ones(b**2) + 'x^2' + sgn(-2*x0*b**2) + 'x' + sgn(-a**2) + 'y^2' + sgn(2*y0*a**2) + 'y' + sgn_last(b**2*x0**2-a**2*y0**2) + '=0'
    if k == 6: # точка
        a = randint(1,9)
        b = randint(1,9)
        x0 = randint(1,5)*(-1)**randint(1,2)
    ...
    if k == 8: # параллельные прямые
        ...
        return no_ones(a**2) + 'x^2' + sgn(2*a*b) + 'xy' + sgn(-a*(x0+y0)*a) + 'x' + sgn(b**2) + 'y^2' + sgn(-a*(x0+y0)*b) + 'y' + sgn_last(x0*y0*a**2) + '=0'
    if k == 9: # парабола ветви вверх/вниз
        p = randint(1,5)*(-1)**randint(1,2)
        x0 = randint(1,5)*(-1)**randint(1,2)
        y0 = randint(1,5)*(-1)**randint(1,2)
        return 'x^2' + sgn(-2*x0) + 'x' + sgn(-2*p) + 'y' + sgn_last(2*p*y0+x0**2) + '=0'
    if k == 10: # парабола ветви влево/вправо
        p = randint(1,5)*(-1)**randint(1,2)
        x0 = randint(1,5)*(-1)**randint(1,2)
        y0 = randint(1,5)*(-1)**randint(1,2)
        return 'y^2' + sgn(-2*y0) + 'y' + sgn(-2*p) + 'x' + sgn_last(2*p*x0+y0**2) + '=0'
